                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <a href="{{ route('transaksi-by-siswa.export') }}"
                                    class="btn btn-primary" download="true">Export</a>
                                ...
                                <tbody>
                                    @foreach($transaskiSiswa as $transaski)
                                        <tr>
                                            ...
                                            <td>{{ $transaski->created_at->format('Y-m-d') }}
                                            </td>
                                            <td>{{ $transaski->spp->tahun . ' | ' . $transaski->spp->nominalIdr }}
                                            </td>
